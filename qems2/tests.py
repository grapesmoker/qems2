...
class PacketParserTests(SimpleTestCase):
    ...
    def test_tossup_to_html(self):
        ...
        expectedOutput = "<p><strong>(Test)</strong> <i>tossup</i>.</p><p><b><u>test answer</b></u></p>"
        ...
        expectedOutputWithCharCount = expectedOutput + "<p>Character count: 8</p>"
        ...
        expectedOutputWithCategory = "<p><strong>(Test)</strong> <i>tossup</i>.</p><p><b><u>test answer</b></u> {History - American}</p>"
    ...
    def test_bonus_to_html(self):
        ...
        expectedOutput = "<p>Leadin with <i>italics</i> and <strong>(parens)</strong> and _underlines_.</p>"
        expectedOutput += "<p>[10] Part 1 with <i>italics</i> and <strong>(parens)</strong> and _underlines_.</p>"
        expectedOutput += "<p><b><u><i>Answer 1</i></b></u> [or foo <strong>(bar)</strong>]</p>"
        expectedOutput += "<p>[10] Part 2.</p>"
        expectedOutput += "<p><b><u>answer 2</b></u></p>"
        expectedOutput += "<p>[10] Part 3.</p>"
        expectedOutputWithoutLastLine = expectedOutput      
        expectedOutput += "<p><b><u>answer 3</b></u></p>"        
        ...
        expectedOutputWithCharCount = expectedOutput + "<p>Character count (leadin / part 1 / part 2 / part 3):"
        expectedOutputWithCharCount += " 42 / 42 / 7 / 7</p>"
        ...
        self.assertEqual(acf_bonus_no_category.to_html(), expectedOutput)
        expectedOutputWithCategory = expectedOutputWithoutLastLine + "<p><b><u>answer 3</b></u> {History - American}</p>"
        ...
        expectedVhslOutput = "<p>Part 1 with <i>italics</i> and <strong>(parens)</strong> and _underlines_.</p>"
        expectedVhslOutput += "<p><b><u><i>Answer 1</i></b></u> [or foo <strong>(bar)</strong>]</p>"
        self.assertEqual(vhsl_bonus_no_category.to_html(), expectedVhslOutput)
        vhsl_bonus_no_category.category = americanHistory
        self.assertEqual(vhsl_bonus_no_category.to_html(), expectedVhslOutput)
        expectedVhslOutput = "<p>Part 1 with <i>italics</i> and <strong>(parens)</strong> and _underlines_.</p>"
        expectedVhslOutput += "<p><b><u><i>Answer 1</i></b></u> [or foo <strong>(bar)</strong>] {History - American}</p>"
